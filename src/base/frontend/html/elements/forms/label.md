---
title: "<label>"
description: "Подпись элемента управления формы."
outline: [2, 3]
---
...
Подпись элемента управления формы.
...
- **Специальные атрибуты:** [`for`](/base/frontend/html/attributes/element-specific/for).
...
- Не используйте XML-запись `<label />` как замену закрывающему тегу в HTML.

## DOM-интерфейс

Элемент представлен интерфейсом [`HTMLLabelElement`](https://html.spec.whatwg.org/multipage/forms.html#htmllabelelement). Для чтения исходных атрибутов всегда доступны `getAttribute()`, `setAttribute()` и `removeAttribute()`; специализированные IDL-свойства описаны в спецификации интерфейса.

## Спецификация

- [Определение `label` в WHATWG](https://html.spec.whatwg.org/multipage/forms.html#the-label-element)
