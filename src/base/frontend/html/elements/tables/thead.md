---
title: "<thead>"
description: "Группа строк заголовка таблицы."
outline: [2, 3]
---
...
- Не используйте XML-запись `<thead />` как замену закрывающему тегу в HTML.
...
- [Определение `thead` в WHATWG](https://html.spec.whatwg.org/multipage/tables.html#the-thead-element)
