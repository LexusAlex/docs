---
title: "<tfoot>"
description: "Группа итоговых строк таблицы."
outline: [2, 3]
---
...
- Не используйте XML-запись `<tfoot />` как замену закрывающему тегу в HTML.
...
- [Определение `tfoot` в WHATWG](https://html.spec.whatwg.org/multipage/tables.html#the-tfoot-element)
