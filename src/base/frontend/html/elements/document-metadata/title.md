---
title: "<title>"
description: "Название документа для вкладки, истории и результатов поиска."
outline: [2, 3]
---
...
Название документа для вкладки, истории и результатов поиска.
...
| Допустимые родители | [`head`](/base/frontend/html/elements/document-metadata/head) | head |
...
- Не используйте XML-запись `<title />` как замену закрывающему тегу в HTML.

## DOM-интерфейс

Элемент представлен интерфейсом [`HTMLTitleElement`](https://html.spec.whatwg.org/multipage/semantics.html#htmltitleelement). Для чтения исходных атрибутов всегда доступны `getAttribute()`, `setAttribute()` и `removeAttribute()`; специализированные IDL-свойства описаны в спецификации интерфейса.

## Спецификация

- [Определение `title` в WHATWG](https://html.spec.whatwg.org/multipage/semantics.html#the-title-element)
