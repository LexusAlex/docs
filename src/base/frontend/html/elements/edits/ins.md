---
title: "<ins>"
description: "Добавление в документе."
outline: [2, 3]
---
...
- Не используйте XML-запись `<ins />` как замену закрывающему тегу в HTML.
...
- [Определение `ins` в WHATWG](https://html.spec.whatwg.org/multipage/edits.html#the-ins-element)
