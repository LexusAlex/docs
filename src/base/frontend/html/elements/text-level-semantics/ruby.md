---
title: "<ruby>"
description: "Базовый текст с аннотациями произношения или пояснениями."
outline: [2, 3]
---
...
Базовый текст с аннотациями произношения или пояснениями.
...
| Содержимое | фразовое (`phrasing`), [`rt`](/base/frontend/html/elements/text-level-semantics/rt), [`rp`](/base/frontend/html/elements/text-level-semantics/rp) | phrasing ; rt ; rp * |
...
- Не используйте XML-запись `<ruby />` как замену закрывающему тегу в HTML.
...
- [Определение `ruby` в WHATWG](https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-ruby-element)
