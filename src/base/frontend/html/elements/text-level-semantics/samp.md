---
title: "<samp>"
description: "Пример вывода программы или вычислительной системы."
outline: [2, 3]
---
...
Пример вывода программы или вычислительной системы.
...
```html
<p>Терминал ответил: <samp>Permission denied</samp>.</p>
```
...
- Не используйте XML-запись `<samp />` как замену закрывающему тегу в HTML.
...
- [Определение `samp` в WHATWG](https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-samp-element)
