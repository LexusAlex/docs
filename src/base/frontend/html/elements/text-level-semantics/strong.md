---
title: "<strong>"
description: "Высокая важность, серьёзность или срочность текста."
outline: [2, 3]
---
...
Высокая важность, серьёзность или срочность текста.
...
```html
<p><strong>Внимание:</strong> действие нельзя отменить.</p>
```
...
- Не используйте XML-запись `<strong />` как замену закрывающему тегу в HTML.
...
- [Определение `strong` в WHATWG](https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-strong-element)
