---
title: "<kbd>"
description: "Пользовательский ввод, обычно с клавиатуры."
outline: [2, 3]
---
...
Пользовательский ввод, обычно с клавиатуры.
...
```html
<p>Нажмите <kbd><kbd>Ctrl</kbd> + <kbd>S</kbd></kbd>, чтобы сохранить.</p>
```
...
- Не используйте XML-запись `<kbd />` как замену закрывающему тегу в HTML.
...
- [Определение `kbd` в WHATWG](https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-kbd-element)
