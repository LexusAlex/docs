---
title: "<mark>"
description: "Фрагмент, выделенный из-за актуальности в текущем контексте."
outline: [2, 3]
---
...
Фрагмент, выделенный из-за актуальности в текущем контексте.
...
```html
<p>Результат поиска: настройте <mark>безопасность</mark> приложения.</p>
```
...
- Не используйте XML-запись `<mark />` как замену закрывающему тегу в HTML.
...
- [Определение `mark` в WHATWG](https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-mark-element)
