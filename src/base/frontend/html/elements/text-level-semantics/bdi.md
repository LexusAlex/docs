---
title: "<bdi>"
description: "Изолирует направление текста от окружающего двунаправленного контекста."
outline: [2, 3]
---
...
Изолирует направление текста от окружающего двунаправленного контекста.
...
```html
<p>Победитель: <bdi>إيان</bdi> — 1 место.</p>
```
...
- Не используйте XML-запись `<bdi />` как замену закрывающему тегу в HTML.
...
- [Определение `bdi` в WHATWG](https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-bdi-element)
