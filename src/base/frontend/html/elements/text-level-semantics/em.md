---
title: "<em>"
description: "Логическое ударение, меняющее смысл фразы."
outline: [2, 3]
---
...
Логическое ударение, меняющее смысл фразы.
...
```html
<p>Нужно отправить отчёт <em>сегодня</em>, а не завтра.</p>
```
...
- Не используйте XML-запись `<em />` как замену закрывающему тегу в HTML.
...
- [Определение `em` в WHATWG](https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-em-element)
