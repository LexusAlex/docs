---
title: "<var>"
description: "Переменная или заполнитель в математическом либо программном контексте."
outline: [2, 3]
---
...
Переменная или заполнитель в математическом либо программном контексте.
...
- Не используйте XML-запись `<var />` как замену закрывающему тегу в HTML.
...
- [Определение `var` в WHATWG](https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-var-element)
