---
title: "<b>"
description: "Фрагмент, к которому привлекают внимание без повышения важности."
outline: [2, 3]
---
...
Фрагмент, к которому привлекают внимание без повышения важности.
...
```html
<p>Новая версия доступна в тарифе <b>Профессиональный</b>.</p>
```
...
- Не используйте XML-запись `<b />` как замену закрывающему тегу в HTML.
...
- [Определение `b` в WHATWG](https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-b-element)
