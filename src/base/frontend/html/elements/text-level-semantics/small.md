---
title: "<small>"
description: "Побочный комментарий или мелкий печатный текст."
outline: [2, 3]
---
...
Побочный комментарий или мелкий печатный текст.
...
```html
<p><small>Цена включает НДС. Предложение действует до 31 июля.</small></p>
```
...
- Не используйте XML-запись `<small />` как замену закрывающему тегу в HTML.
...
- [Определение `small` в WHATWG](https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-small-element)
