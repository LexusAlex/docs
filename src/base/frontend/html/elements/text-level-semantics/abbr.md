---
title: "<abbr>"
description: "Аббревиатура или сокращение."
outline: [2, 3]
---
...
```html
<p><abbr title="HyperText Markup Language">HTML</abbr> задаёт структуру документа.</p>
```
...
- Не используйте XML-запись `<abbr />` как замену закрывающему тегу в HTML.
...
- [Определение `abbr` в WHATWG](https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-abbr-element)
