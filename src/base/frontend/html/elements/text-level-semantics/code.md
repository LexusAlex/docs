---
title: "<code>"
description: "Фрагмент компьютерного кода."
outline: [2, 3]
---
...
- Не используйте XML-запись `<code />` как замену закрывающему тегу в HTML.
...
- [Определение `code` в WHATWG](https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-code-element)
