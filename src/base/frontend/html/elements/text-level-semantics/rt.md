---
title: "<rt>"
description: "Текст ruby-аннотации."
outline: [2, 3]
---
...
- Не используйте XML-запись `<rt />` как замену закрывающему тегу в HTML.
...
- [Определение `rt` в WHATWG](https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-rt-element)
