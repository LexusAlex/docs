---
title: "<header>"
description: "Вводное содержимое или навигационные средства ближайшего раздела."
outline: [2, 3]
---
...
Вводное содержимое или навигационные средства ближайшего раздела.
...
- Не используйте XML-запись `<header />` как замену закрывающему тегу в HTML.
...
- [Определение `header` в WHATWG](https://html.spec.whatwg.org/multipage/sections.html#the-header-element)
