---
title: "<section>"
description: "Тематический раздел документа, обычно с собственным заголовком."
outline: [2, 3]
---
...
Тематический раздел документа, обычно с собственным заголовком.
...
- Не используйте XML-запись `<section />` как замену закрывающему тегу в HTML.
...
- [Определение `section` в WHATWG](https://html.spec.whatwg.org/multipage/sections.html#the-section-element)
