---
title: "<article>"
description: "Самостоятельная композиция, пригодная для независимого распространения или повторного использования."
outline: [2, 3]
---
...
Самостоятельная композиция, пригодная для независимого распространения или повторного использования.
...
- Не используйте XML-запись `<article />` как замену закрывающему тегу в HTML.
...
- [Определение `article` в WHATWG](https://html.spec.whatwg.org/multipage/sections.html#the-article-element)
