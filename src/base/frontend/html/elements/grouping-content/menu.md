---
title: "<menu>"
description: "Список команд или элементов интерфейса, представленный как список."
outline: [2, 3]
---
...
Список команд или элементов интерфейса, представленный как список.
...
- Не используйте XML-запись `<menu />` как замену закрывающему тегу в HTML.

## DOM-интерфейс

Элемент представлен интерфейсом [`HTMLMenuElement`](https://html.spec.whatwg.org/multipage/grouping-content.html#htmlmenuelement). Для чтения исходных атрибутов всегда доступны `getAttribute()`, `setAttribute()` и `removeAttribute()`; специализированные IDL-свойства описаны в спецификации интерфейса.

## Спецификация

- [Определение `menu` в WHATWG](https://html.spec.whatwg.org/multipage/grouping-content.html#the-menu-element)
