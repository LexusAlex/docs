---
title: "<search>"
description: "Контейнер средств поиска или фильтрации."
outline: [2, 3]
---
...
Контейнер средств поиска или фильтрации.
...
- Не используйте XML-запись `<search />` как замену закрывающему тегу в HTML.
...
- [Определение `search` в WHATWG](https://html.spec.whatwg.org/multipage/grouping-content.html#the-search-element)
