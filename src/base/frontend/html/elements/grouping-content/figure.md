---
title: "<figure>"
description: "Самостоятельный материал, на который можно ссылаться как на единое целое."
outline: [2, 3]
---
...
Самостоятельный материал, на который можно ссылаться как на единое целое.
...
| Содержимое | [`figcaption`](/base/frontend/html/elements/grouping-content/figcaption), потоковое (`flow`) | figcaption *; flow |
...
- Не используйте XML-запись `<figure />` как замену закрывающему тегу в HTML.
...
- [Определение `figure` в WHATWG](https://html.spec.whatwg.org/multipage/grouping-content.html#the-figure-element)
