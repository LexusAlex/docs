---
title: "<main>"
description: "Доминирующее содержимое документа."
outline: [2, 3]
---
...
Доминирующее содержимое документа.
...
- Не используйте XML-запись `<main />` как замену закрывающему тегу в HTML.
...
- [Определение `main` в WHATWG](https://html.spec.whatwg.org/multipage/grouping-content.html#the-main-element)
