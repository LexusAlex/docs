---
title: "<dt>"
description: "Имя или термин внутри dl."
outline: [2, 3]
---
...
- Не используйте XML-запись `<dt />` как замену закрывающему тегу в HTML.
...
- [Определение `dt` в WHATWG](https://html.spec.whatwg.org/multipage/grouping-content.html#the-dt-element)
